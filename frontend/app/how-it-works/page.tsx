...
const LAYERS = [
  ...
  },
  {
    ...
    color: "#ec4899",
    details: [
      "Login is handled by Auth0 — users authenticate with their UW email (@uw.edu or @washington.edu)",
      "Non-UW accounts are blocked server-side in the Auth0 callback before a session is created",
    ...
    flow: ["UW email login", "Auth0 tenant", "UW domain check", "Session created", "Hashed sub → recommender"],
  },
  {
    number: "05",
